...
import RegularFilter from "./RegularFilter.js";
...
Filter.controlButtons = true;
new Filter();
new MainFilter('cities','City');
new MainFilter('managers','Manager');
new MainFilter('developers','Developer',true);
new RegularFilter('companies','Companies','additional','Additional',);
new RegularFilter('technologies','Technologies');
